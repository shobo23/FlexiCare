  ...
  return (
    <div className="w-screen flex justify-center items-center h-screen ">
      ...
      <div className="flex justify-start w-full">
        <IoChevronBackCircleOutline onClick={() => Nav('/getstarted')} className="size-10 text-sky-700 cursor-pointer hover:text-[#E45E32]"/>
        </div>
        <div className="w-130">
          <img
            src={Pic}
        ...
        <div>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              type="email"
              name="email"
              className="border px-2 text-white border-[#E7E6DD] w-full rounded-[3px] p-[3px]" required
            />
          </div>
          <div>
