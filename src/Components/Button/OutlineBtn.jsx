...
const OutlineBtn = ({text}) => {
  return (
    <div>
        <button class="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-[#C3D3D2] rounded hover:bg-white group py-1.5 px-2.5 cursor-pointer border border-sky-700">
